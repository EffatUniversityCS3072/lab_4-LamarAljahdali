...
rpart_model = train(Species ~ ., data=trainData, method='rpart', 
trControl=control, metric=metric)
#---------------------------------------------------------------------------
# Set the seed for reproducibility
set.seed(100)
...
rf_model = train(Species ~ ., data=trainData, method='rf', trControl=control, 
metric=metric)
...
models_compare<-resamples(list(lda=lda_model, rpart=rpart_model, 
